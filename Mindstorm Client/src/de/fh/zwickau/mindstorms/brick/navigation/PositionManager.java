...
//					+ Math.pow(targetPose.getY() - pose.getY(), 2)) / 2;
//			if(pose.getHeading() >= 0 && pose.getHeading() < 180) {
//				if (pose.getX() > targetPose.getX())
//					movementManager.move(-newDistance);
//				else 
//					movementManager.move(newDistance);
//			}
//			if(pose.getHeading() >= 180 && pose.getHeading() < 360) {
//				if (pose.getX() < targetPose.getX())
//					movementManager.move(-newDistance);
//				else 
//					movementManager.move(newDistance);
